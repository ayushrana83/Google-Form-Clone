...
function page() {
  return (
    <div className="h-screen max-w-screen-2xl flex items-center justify-center bg-[var(--bg-color)]">
      <div className="shadow-2xl w-md rounded border-t-8 border-t-[var(--primary-color)] bg-white" >
        ...
        <form className="w-full h-full space-y-4 p-7 text-lg">
            ...
            <div className="flex flex-col space-y-3">
              <label>Name</label>
              <input type="text" placeholder="Enter Name" className="outline-none px-2 py-1 border-b shadow-2xl bg-gray-100" />
            </div>
            <div className="flex flex-col space-y-3">
              <label>Email</label>
          ...
          <div className="text-base">
           Have an account ?
            <span className="text-[var(--primary-color)]">Sign in Here</span>
          </div>
        </form>
      </div>
    </div>
